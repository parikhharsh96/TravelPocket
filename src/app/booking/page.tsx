        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-center md:relative gap-4">
            <div className="text-center">
              <h1 className="text-2xl md:text-3xl font-bold mb-2">Kailash Mansarovar Yatra</h1>
              <p className="text-sm md:text-base text-muted-foreground">
                Charan Sparsh Outer Kora from Lucknow By Helicopter
              </p>
            </div>
            <div className="md:absolute md:right-0 flex items-center justify-center gap-2 bg-accent px-4 py-2 rounded-md">
              <Calendar className="w-4 h-4 text-primary" />
              <span className="text-sm font-medium">11 NIGHTS 12 DAYS</span>
            </div>
          </div>
        </div>
      </div>
